...
export default function Topbar({ sidebarOpen, setSidebarOpen, dark, setDark }) {
    ...
    return (
        <>
            <style>{`
                ...
                .topbar-dropdown-anim { animation: topbarDropdownIn 0.15s ease-out; transform-origin: top right; }
            `}</style>
            ...
            `}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative" ref={userMenuRef}>
                        ...
                        {openUser && (
                            <div className={`
                                topbar-dropdown-anim absolute right-0 mt-2 w-64 rounded-2xl shadow-2xl overflow-hidden border
                            ...
                            `}>
                                ...
                                <div className={`flex items-center gap-3 px-4 py-4 ${dark ? "bg-slate-800/60" : "bg-gray-50/70"}`}>
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <div className={`text-xs truncate ${dark ? "text-slate-400" : "text-gray-500"}`}>
                                            User
                                        </div>
                                    </div>
                                </div>
